package wiki.csbox.csboxbase.handler;
...
import wiki.csbox.csboxbase.constant.CommonError;
import wiki.csbox.csboxbase.exception.CSBoxVideoException;
import wiki.csbox.csboxbase.exception.RestErrorResponse;
...
public class GlobalExceptionHandler {
     ...
     */
    @ExceptionHandler(CSBoxVideoException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public RestErrorResponse customerException(CSBoxVideoException exception) {
        // 日志输出异常信息：
